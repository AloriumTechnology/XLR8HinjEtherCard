...
#ifndef XLR8_EtherCard_h
#define XLR8_EtherCard_h
...
*/
class XLR8HinjEtherCard : public XLR8Ethernet {
public:
...
extern XLR8HinjEtherCard XLR8Ether; //!< Global presentation of XLR8EtherCard class
